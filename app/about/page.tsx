          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {[
              ...
              },
              {
                ...
                description:
                  "Professional installation and setup by trained technicians with after-sales support",
              },
              {
                title: "Affordable Pricing",
                description:
                  "Premium quality water purifiers at competitive prices with easy payment options",
              },
              {
                title: "Warranty & Service",
                description:
                  "5-year comprehensive warranty with free maintenance and filter replacement support",
              },
              {
                title: "Eco-Friendly",
                description:
                  "Sustainable solutions that minimize water waste and protect the environment",
              },
              {
                title: "24/7 Support",
                description:
                  "Dedicated customer support team available for any queries or service requests",
              },
            ].map((item, index) => (
              <div
                key={index}
                className="p-6 rounded-lg shadow-lg hover:shadow-2xl transition-transform transform hover:scale-105"
                style={{
                  background: "linear-gradient(to right, #7C7C7C, #A2A2A2)",
                }}
              >
