    ...
    <main className="min-h-screen bg-background">
      ...
      <section className="py-16 md:py-24">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            {services.map((service) => (
              <Link key={service.id} href={service.link}>
                <div className="h-full p-8 bg-white rounded-lg shadow-md hover:shadow-xl transition-all transform hover:scale-105 border-t-4 border-primary cursor-pointer">
          ...
          {/* Call to Action */}
          <div className="bg-gradient-to-r from-primary to-primary/80 text-white p-8 md:p-12 rounded-lg text-center">
            <h3 className="text-2xl md:text-3xl font-bold mb-4">Need Our Services?</h3>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                ...
                className="inline-block px-8 py-3 bg-white text-primary hover:bg-white/90 font-bold rounded-lg transition-colors"
              >
                Call: +91 98765 43210
              </a>
              <a
                href="https://wa.me/919876543210"
                className="inline-block px-8 py-3 bg-secondary text-secondary-foreground hover:bg-secondary/90 font-bold rounded-lg transition-colors"
              >
                WhatsApp Us
              </a>
            </div>
